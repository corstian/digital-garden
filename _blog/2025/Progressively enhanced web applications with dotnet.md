...
In a previous post I had been railing against the architectural decisions underpinning Blazor. The development of a performant progressively enhanced web application seems to h
