...
In a previous post I had been railing against the architectural decisions underpinning Blazor. The development of progressively enhanced applications as a first priority seems to be an afterthought using Blazor.
