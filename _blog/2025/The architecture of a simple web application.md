...
The fact that HTTP itself is a stateless protocol should act as encouragement for application developers to think thoroughly about the structure of their API in consolidation with the way users intend to use their applications. While client-side frontend applications have an edge here to