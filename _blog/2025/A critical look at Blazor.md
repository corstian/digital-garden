...
With over a decade in IT - parts of which spent on front-end technology - my views might be slightly old-fashioned. It might totally be the case that I am totally missing the point of this awesome new technology. What I learned from these years dealing with front-ends however is that 