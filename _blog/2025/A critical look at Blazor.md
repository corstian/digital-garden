...
With over a decade in IT - parts of which spent on front-end technology - my views might be slightly old-fashioned. It might totally be the case that I am totally missing the point of this awesome new technology. Over these years dealing with front-end technology however I started to lean into the stateless nature of APIs. It is with a well-designed boundary of an application