...
The problems do not stop here. If the global state had changed in the meantime - meaning Blazor could not reconstruct the original page markup - this might very well mean that the original form could not be retrieved a
