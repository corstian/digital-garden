...
> If you are interested in running the domain library and Marten, just copy paste the examples in this post. There's not going to be a nuget package. Configuration tweaks are just easier to do
