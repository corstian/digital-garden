...
## Remarks
It is stuff like this where the rough edges of the domain library show. Things like identifiers, aggregate initialization and all of that might require a bit more work. It is for reasons 