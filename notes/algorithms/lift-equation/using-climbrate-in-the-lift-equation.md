...
*See also [Position, Velocity, Acceleration and Jerk]({% link notes/algorithms/lift-equation/position-velocity-acceleration-jerk.md %}) for a handy chart on the differences between these.*