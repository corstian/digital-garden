...
> See [these pages]({% link notes/algorithms/spatiotemporal-trajectory-matching/index.md %}) as well for more background to an actual implementation of this paper as well.
